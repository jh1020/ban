...
<body>
    ...
    $(function(){
        ...
        IMP.request_pay({
            ...
            buyer_name : '${user.data.account}',
            buyer_tel : '${user.data.phoneNumber}',
            buyer_addr : '강서구',
            ...
            if ( rsp.success ) {
                ...
                form.setAttribute("action", "/clientPage/orderItem.do");
                document.body.appendChild(f);
                
                var itemId = document.createElement("input");
                itemId.setAttribute("type", "hidden");
                itemId.setAttribute("name", "item_id");
                itemId.setAttribute("value", ${item.data.id});
                itemId.appendChild(itemId);
